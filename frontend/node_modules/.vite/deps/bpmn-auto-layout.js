...
function connectElements(source, target, layoutGrid) {
  ...
  const baseSourceGrid = source.grid || ((_a = source.attachedToRef) == null ? void 0 : _a.grid);
...
function getMaxExpandedBetween(source, target, layoutGrid) {
  ...
  return elementsInRange.reduce((acc, cur) => {
    var _a, _b;
    if (((_a = cur.grid) == null ? void 0 : _a.getGridDimensions()[0]) > acc) return (_b = cur.grid) == null ? void 0 : _b.getGridDimensions()[0];
  }, 0);
}
var Grid = class {
  constructor() {
...
function hasOtherIncoming(element) {
  var _a, _b;
  const fromHost = ((_a = element.incoming) == null ? void 0 : _a.filter((edge) => edge.sourceRef !== element && edge.sourceRef.attachedToRef === void 0)) || [];
  const fromAttached = (_b = element.incoming) == null ? void 0 : _b.filter((edge) => edge.sourceRef !== element && edge.sourceRef.attachedToRef !== element);
  return (fromHost == null ? void 0 : fromHost.length) > 0 || (fromAttached == null ? void 0 : fromAttached.length) > 0;
}
